...
public class Tack : MonoBehaviour
{
    ...
    void Start()
    {
        double [,] plst = new double [5,3]{{45.344,3.755,48.428},{58.795,4.053,43.29},{65.29,4.053,42.686},{78.81,5.42,44.156},{67.001,3.983,85.646}};
        System.Random rd = new System.Random();
        int i = rd.Next(5);
        Item.transform.position = new Vector3((float)plst[i, 0], (float)plst[i,1], (float)plst[i,2]);
    }
    void Update()
    {
